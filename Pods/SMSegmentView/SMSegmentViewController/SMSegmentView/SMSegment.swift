...
public class SMSegment: SMBasicSegment {
    ...
    private func resetContentFrame() {
        ...
        var imageViewFrame = CGRect.init(x: 0.0, y: self.verticalMargin, width: 0.0, height: self.frame.size.height - self.verticalMargin * 2)
        ...
        self.label.frame = CGRect.init(x: imageViewFrame.origin.x + imageViewFrame.size.width + distanceBetween, y: self.verticalMargin, width: self.labelWidth, height: self.frame.size.height - self.verticalMargin * 2) 
    }
